        ...
        {activeTab === 'about' && (
          <div className="about-container">
            ...
            <div className="credits-list">
              <button className="credit-item" onClick={() => openLink('https://github.com/hect0x7')}>
              ...
              <button className="credit-item" onClick={() => openLink('https://github.com/hect0x7/cockpit-tools')}>
                <div className="credit-icon" style={{ color: '#0f172a' }}><Github size={24} /></div>
                <h3>{t('settings.about.github')}</h3>
                <p>cockpit-tools</p>
              </button>

              <button className="credit-item" onClick={() => openLink('https://github.com/hect0x7/cockpit-tools/blob/main/docs/DONATE.md')}>
              ...
              <button className="credit-item" onClick={() => openLink('https://github.com/hect0x7/cockpit-tools/issues')}>
